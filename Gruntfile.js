    ...
    sass: {                              // Task
      dist: {                            // Target
        ...
        files: {                         // Dictionary of files
          ...
          'views/css/dashboard-mobile-table-331.css': 'views/src/dashboard-mobile-table-331.scss',
          'views/css/dashboard-mobile-table-320.css': 'views/src/dashboard-mobile-table-320.scss',
